...
export default function Sales({ db, save }: Props) {
  ...
  const saveSale = () => {
    ...
    const sale: Sale = {
      ...
      cariName: customerId
        ? db.cari.find((c) => c.id === customerId)?.name
        : undefined,
      ...
      productCategory: items[0]
        ? db.products.find((p) => p.id === items[0].productId)?.category
        : undefined,
    ...
    save((prev) => {
      ...
      const fiiliTahsilat =
        tahsilat === "" && payment === "cari" ? 0 : tahsilatNum;
      if (fiiliTahsilat > 0) {
    ...
    showConfirm(
      ...
      () => {
        ...
        save((prev) => {
          ...
          const tahsilEdilen = relatedKasaEntries.reduce(
            (s, k) => s + k.amount,
            0,
          );
            ...
            {sorted.length === 0 ? (
              ...
              sorted.map((s) => (
                ...
                >
                  ...
                  >
                    {db.cari.find((c) => c.id === s.customerId)?.name || "-"}
                  </td>
        ...
        <div style={{ display: "flex", gap: 16, flexWrap: "wrap" }}>
          ...
          <div style={{ flex: "1 1 220px" }}>
            ...
            <MobileSelect
              ...
              style={{
                borderColor: !customerId ? "rgba(239,68,68,0.4)" : undefined,
              }}
            />
