...
- Name: inventory.spec.ts >> tedarikci ekleme akisi calisiyor
- Location: e2e\inventory.spec.ts:24:1
...
Call log:
  - waiting for getByText('Tedarikçi', { exact: true }).first()
...
```ts
  ...
  23  |       stock: 12,
  24  |       minStock: 3,
  25  |       createdAt: '2026-05-06T09:00:00.000Z',
  26  |       updatedAt: '2026-05-06T09:00:00.000Z',
  27  |     },
  28  |   ],
  29  |   suppliers: [
  30  |     {
  31  |       id: 'sup-1',
  32  |       name: 'Test Tedarikci',
  33  |       category: 'Genel',
  34  |       phone: '05000000000',
  35  |       totalOrders: 0,
  36  |       totalAmount: 0,
  37  |       createdAt: '2026-05-06T09:00:00.000Z',
  38  |       updatedAt: '2026-05-06T09:00:00.000Z',
  39  |     },
  40  |   ],
  41  |   orders: [],
  42  |   cari: [
  43  |     {
  44  |       id: 'cari-1',
  45  |       name: 'Test Musterisi',
  46  |       type: 'musteri',
  47  |       balance: 0,
  48  |       phone: '05550000000',
  49  |       createdAt: '2026-05-06T09:00:00.000Z',
  50  |       updatedAt: '2026-05-06T09:00:00.000Z',
  51  |     },
  52  |   ],
  53  |   sales: [],
  54  |   kasa: [],
  ...
  116 | }
  117 | 
  118 | export async function openModule(page: Page, label: string) {
> 119 |   await page.getByText(label, { exact: true }).first().click();
      |                                                        ^ Error: locator.click: Test timeout of 30000ms exceeded.
  120 |   await expect(page.getByRole('heading', { name: new RegExp(label, 'i') })).toBeVisible();
  121 | }
  122 | 
  123 | export async function readDb(page: Page) {
  124 |   return await page.evaluate(() => {
  125 |     const raw = window.localStorage.getItem('sobaYonetim');
