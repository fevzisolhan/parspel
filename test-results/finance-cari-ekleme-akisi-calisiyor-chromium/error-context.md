...
- Name: finance.spec.ts >> cari ekleme akisi calisiyor
- Location: e2e\finance.spec.ts:9:1
...
Locator: getByRole('table').getByText('Yeni Cari Test')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('table').getByText('Yeni Cari Test')
    ...
    - generic [ref=e3]:
      ...
      - generic [ref=e122]:
        - banner [ref=e123]:
          ...
          - generic [ref=e128]:
            - generic: 🔍
            - textbox "Ürün, müşteri, modül ara..." [ref=e129]: Yeni Cari Test
